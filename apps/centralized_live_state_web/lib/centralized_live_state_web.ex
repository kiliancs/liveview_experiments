defmodule CentralizedLiveStateWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: CentralizedLiveStateWeb
      import Plug.Conn
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/centralized_live_state_web/templates",
        namespace: CentralizedLiveStateWeb
